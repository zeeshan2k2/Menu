    ...
    var body: some View {
        VStack {
            ...
            VStack {
                ...
                HStack(spacing: 40) {
                    NutritionInfo(name: "Calories", value: "\(appetizer.calories)")
                    NutritionInfo(name: "Carbs", value: "\(appetizer.carbs) g")
                    NutritionInfo(name: "Protein", value: "\(appetizer.protein) g")
                }
            }
